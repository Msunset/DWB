...
public class GlobalExceptionHandler {
    private static final Logger logger = LoggerFactory.getLogger(com.dwb.config.GlobalExceptionHandler.class);
    ...
    public Result bizExceptionHandler(HttpServletRequest req, BizException e){
        ...
        return Result.newErrorException(e.getErrorCode(),e.getErrorMsg());
    }
